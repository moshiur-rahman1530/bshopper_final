    ...
    <div class="modal-header">
      ...
      <div class="modal-body d-none text-center" id="updateCategoryModalDNone">
       ...
       <input id="UpdateCategoryNameId" type="text" id="" class="form-control mb-3" placeholder="Category Name">
      	 	<input id="UpdateCategoryDesId" type="text" id="" class="form-control mb-3" placeholder="Category Description">
     			<!-- <input id="UpdateCategoryImgId" type="text" class="form-control mb-3" placeholder="Category Image"> -->
           <select id="updateCategoryStatus" class="w-100 mb-3" style="height:36px" name="cat_id">
...
// update deatils category fetch
  ...
  axios.post('/categoryDetails',{
    id:id
        ...
        if(response.status==200 && response.data){
            ...
            // $('#UpdateCategoryImgId').val(jsonData[0].img);
            // $('.profile-photo').val(jsonData[0].img);
            $('#updateCategoryStatus').val(jsonData[0].status);
 ...
 $('#CategoryUpdateConfirmBtn').click(function(){
  ...
  var status =  $('#updateCategoryStatus').val();
