               ...
               if ($request->hasFile('img'.$x)) 
                {
                  ...
                  // $success = $file->move($upload_path, $productImgName);
                  // $uploadedFile = copy($upload_path.$productImgName, $all_upload_path.$productImgName);
                  ...
                  // array_push($allproduct_image_url, $product_image_url);
                  $allImagesUpload = Image::create(['name'=>$productImgName, 'path'=>$backupDisk]);
                  // $allImagesUpload = Image::create(['name'=>$productImgName, 'path'=>$all_image_url]);
         ...
         if ($req->hasFile('img'.$y)) 
          {
            ...
            // $success = $file->move($upload_path, $productUpdateImgName);
            // $uploadedFile = copy($upload_path.$productUpdateImgName, $all_upload_path.$productUpdateImgName);
            ...
            // array_push($allUpdateProduct_image_url, $product_image_url);
            $allImagesUpload = Image::create(['name'=>$productUpdateImgName, 'path'=>$backupUpdateDisk]);
            // $allImagesUpload = Image::create(['name'=>$productUpdateImgName, 'path'=>$all_image_url]);
            ...
            // foreach( $old_images_update as $old_image){
